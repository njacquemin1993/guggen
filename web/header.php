        ...
        <table>
          <tbody>
            <tr>
              ...
              <td> <a onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image19','','/images/menu2_10.gif',1)" href="/galerie/index.php"><img class="header" src="/images/bar-menu_10.gif" name="Image19" id="Image19" border="0" style="max-width:63px; width:100%;" /></a></td>
